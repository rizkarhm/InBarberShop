...
?>
    ...
    <section class="content">
        ...
        <div class="card card-info">
            ...
            ?>
            <form class="form-horizontal" action="index.php?include=userKonfirmasiEdit" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="nim" id="email" value="<?php echo $nim; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="email" class="col-sm-3 col-form-label">Jobdesk</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="job" id="email" value="<?php echo $job; ?>">
                        </div>
                    </div>
                    <div class="form-group row">
